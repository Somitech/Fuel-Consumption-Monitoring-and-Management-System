...
namespace oil
{
    public partial class CarUpdate : Form
    {
        ...
        public CarUpdate(string carNumber)
        {
            InitializeComponent();
        ...
        private void saveButton_Click(object sender, EventArgs e)
        {
            if (carID.Text != "" && carModel.Text != "" && this.carReceaver.Text != "")
            {
                ...
                string query;
                    ...
                    query = "Update Car SET CarID = '" + carId1 + "' ,CarModel = '" + carModel1 + "' ,UsingType = " + carType1 + " ,ReceaverID = " + carReceaver1 + " ,ConsumingRate = " + consumingRate1 + "Where CarID = '" + carNumber + "'";
                    db.update(query);
