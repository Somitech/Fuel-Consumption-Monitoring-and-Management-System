        ...
        void getFreeCouponInfo()
        {
            ...
            if (this.period.Checked)
            {
                ...
                query0 = "SELECT COUNT(*) as CouponNumber"
                   ...
                   + " WHERE  (Coupon.IsFree = 0) AND (Receaver.ReceaverName ='" + this.receaverName.Text + "') AND (DATEPART(year, GivingCoupon.GivingDate) between '" + startYear + "' and '" + endYear + "') AND (DATEPART(month, GivingCoupon.GivingDate) between '" + startMonth + "' and '" + endMonth + "') AND (DATEPART(day, GivingCoupon.GivingDate) between '" + startDay + "' and '" + endDay + "')";
